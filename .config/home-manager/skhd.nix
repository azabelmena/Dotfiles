  ...
  services = {
    skhd = {
      ...
      skhdConfig = ''
        ...
        cmd - s           : /Applications/Safari.app/Contents/MacOS/Safari
        ctrl + cmd - s    : '/Applications/Nix Apps/Spotify.app/Contents/MacOS'/Spotify
        ctrl + cmd - z    : zathura
        ctrl + cmd - p    : /System/Applications/Preview.app/Contents/MacOS/Preview
        ...
        shift + cmd - tab : yabai -m window --focus prev || yabai -m window --focus last
