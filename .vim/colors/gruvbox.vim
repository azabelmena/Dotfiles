...
let s:gb.dark0_hard  = ['#32302f', 234]     " 29-32-33
let s:gb.dark0       = ['#32302f', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#32302f', 237]     " 60-56-54
let s:gb.dark2       = ['#32302f', 239]     " 80-73-69
let s:gb.dark3       = ['#32302f', 241]     " 102-92-84
let s:gb.dark4       = ['#32302f', 243]     " 124-111-100
let s:gb.dark4_256   = ['#32302f', 243]     " 124-111-100

let s:gb.gray_245    = ['#928374', 245]     " 146-131-116
let s:gb.gray_244    = ['#928374', 244]     " 146-131-116

let s:gb.light0_hard = ['#ebdbb2', 230]     " 249-245-215
let s:gb.light0      = ['#ebdbb2', 229]     " 253-244-193
let s:gb.light0_soft = ['#ebdbb2', 228]     " 242-229-188
let s:gb.light1      = ['#ebdbb2', 223]     " 235-219-178
let s:gb.light2      = ['#ebdbb2', 250]     " 213-196-161
let s:gb.light3      = ['#ebdbb2', 248]     " 189-174-147
let s:gb.light4      = ['#ebdbb2', 246]     " 168-153-132
let s:gb.light4_256  = ['#ebdbb2', 246]     " 168-153-132

let s:gb.bright_red     = ['#fb4934', 167]     " 251-73-52
let s:gb.neutral_red    = ['#fb4934', 124]     " 204-36-29
let s:gb.faded_red      = ['#fb4934', 88]      " 157-0-6

let s:gb.bright_green   = ['#b8bb26', 142]     " 184-187-38
let s:gb.neutral_green  = ['#b8bb26', 106]     " 152-151-26
let s:gb.faded_green    = ['#b8bb26', 100]     " 121-116-14

let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.neutral_yellow = ['#fabd2f', 172]     " 215-153-33
let s:gb.faded_yellow   = ['#fabd2f', 136]     " 181-118-20

let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:gb.neutral_blue   = ['#83a598', 66]      " 69-133-136
let s:gb.faded_blue     = ['#83a598', 24]      " 7-102-120

let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.neutral_purple = ['#d3869b', 132]     " 177-98-134
let s:gb.faded_purple   = ['#d3869b', 96]      " 143-63-113

let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:gb.neutral_aqua   = ['#8ec07c', 72]      " 104-157-106
let s:gb.faded_aqua     = ['#8ec07c', 66]      " 66-123-88

let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25
let s:gb.neutral_orange = ['#fe8019', 166]     " 214-93-14
let s:gb.faded_orange   = ['#fe8019', 130]     " 175-58-3
